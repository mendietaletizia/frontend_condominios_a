...
export const mantenimientoAPI = {
  ...
  async getBitacorasMantenimiento() {
    try {
      const response = await api.get('/mantenimiento/bitacoras-mantenimiento/');
      return response.data;
    } catch (error) {
      throw error;
    }
  ...
  async createBitacoraMantenimiento(bitacoraData) {
    try {
      const response = await api.post('/mantenimiento/bitacoras-mantenimiento/', bitacoraData);
      return response.data;
    } catch (error) {
      throw error;
    }
  ...
  async updateBitacoraMantenimiento(id, bitacoraData) {
    try {
      const response = await api.put(`/mantenimiento/bitacoras-mantenimiento/${id}/`, bitacoraData);
      return response.data;
    } catch (error) {
      throw error;
    }
  ...
  async deleteBitacoraMantenimiento(id) {
    try {
      const response = await api.delete(`/mantenimiento/bitacoras-mantenimiento/${id}/`);
      return response.data;
    } catch (error) {
      throw error;
    }
